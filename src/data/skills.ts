...
const skills: readonly Skill[] = [
  {
    ...
    description: '주력 언어. Django/FastAPI/Flask 백엔드, 알고리즘 문제풀이/콘텐츠 제작.',
  },
  {
    name: 'Ruby',
    slug: 'ruby',
    ...
    experienceYears: 3,
    projectSlugs: [],
    description: '그렙 채용서비스팀에서 Rails 풀스택 개발 3년.',
  },
  {
    ...
    description: 'Vue.js/React.js 프론트 개발 및 SPA 포팅.',
  },
  {
    name: 'C / C++',
    slug: 'cpp',
    ...
    level: 'proficient',
    projectSlugs: [],
    description: 'PCCP Lv.4, 알고리즘 문제 출제, 5000+ 문제 풀이.',
  },
  {
    name: 'Java',
    slug: 'java',
