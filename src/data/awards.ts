...
export const awards: readonly Award[] = [
  ...
  {
    title: '2017 제 5회 한국로보컵오픈대회 Soccer Light Weight 부문',
...
export const certifications: readonly Certification[] = [
  ...
  { title: 'COS Professional 1급 (C++)', date: '2022-01' },
